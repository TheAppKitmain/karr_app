...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> fetchallTolls() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (mounted) setState(() {});
        print(
            'tolls screen :API request failed with status code ${response.statusCode}');
      }
    } catch (e) {
                            ...
                            child: Column(
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    padding: EdgeInsets.only(left: 16.0,right: 16,top: 16,bottom: 7),
                                    decoration: BoxDecoration(
                                  ...
                                  children: [
                                    ...
                                    Visibility(
                                        ...
                                        child: allTolls.isNotEmpty
                                            ...
                                            : Container(
                                                height: height*0.45,
                                                child: Text("No tolls found"))),
                                    Visibility(
                                        visible: _isSelectedparking!,
                                        child: allTickets.isNotEmpty
                                            ? Container(
                                                height: height*0.45,
                                                padding: EdgeInsets.only(
                                                    left: 16.0,
  ...
  Widget _buildSegment(
      String iconData, String title, String number, double fontsize,bool is_select) {
    return Column(
      children: [
        SvgPicture.asset(
          iconData,
