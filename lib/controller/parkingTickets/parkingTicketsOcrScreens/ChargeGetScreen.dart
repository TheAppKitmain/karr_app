...
class ChargeGetScreen extends StatefulWidget {
  final VoidCallback onPrevious;
  final VoidCallback onNext;
  ChargeGetScreen({required this.onPrevious, required this.onNext});

  @override
  _ChargeGetScreenState createState() => _ChargeGetScreenState(onPrevious: onPrevious,onNext:onNext );
}

class _ChargeGetScreenState extends State<ChargeGetScreen> {
  final VoidCallback onPrevious;
  final VoidCallback onNext;
  _ChargeGetScreenState({required this.onPrevious, required this.onNext});
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      ...
                      await SharedStorage().saveStringToLocalStorage('Ticket_charge', updatedText);
                      onNext();
